...
const DATA: ProjectsById = {
  ...
  robb: {
    ...
    description: [
      'Robb Report ist die weltweit erfolgreichste Medienmarke im Luxussegment. Das Luxusmagazin spürt der Frage nach, wie sich ein zeitgemäßer Luxusbegriff in seiner Vielfalt definiert. Das Layout ist elegant und zeitlos. Das Titelkonzept wurde dahingehend geändert, dass es jetzt immer illustrativ gelöst wird.'
    ],
    numImages: 6
  },
  'landlust-zuhaus': {
    ...
    company: 'Deutsche Medien-Manufaktur ',
    description: [
      'Landlust Zuhaus ist das Wohnmagazin der Zeitschrift LANDLUST. Mit der Ausgabe 01/2021 wurde das Wohnmagazin Landlust Zuhaus mit modernem Layout frisch renoviert und erweitertem Themenspektrum ergänzt.'
    ],
    numImages: 6
  },
  'einfach-hausgemacht': {
    ...
    company: 'Deutsche Medien-Manufaktur',
    description: [
      'Einfach Hausgemacht ist ein Magazin mit kreativen Rezeptideen, Do-It-Yourself-Bastel- und Dekotipps und praktischem Haushaltswissen aus der Landlust-Familie. Schwerpunkt von Einfach Hausgemacht ist Kochen und Essen. Es ist eine hochwertige, detailverliebt gestaltete und getexte, eigenständige Zeitschrift. '
    ],
    numImages: 5
  },
  'hygge-spezial': {
