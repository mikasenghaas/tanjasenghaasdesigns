...
const DATA: ProjectsById = {
  jayjays: {
    ...
    date: new Date('2021'),
    description: [
      'Logoentwicklung für die Restaurant-Kette Jayjay´s in Hamburg.'
    ],
  ...
  mineralum: {
    ...
    date: new Date('2022'),
    description: [
      'Logo-Redesign und Werbemittelgestaltung für den Handwerksbetrieb und Produkthandel Mineralum und seiner Schwesterfirma Produktum.',
  ...
  'kristin-nowak-logo': {
    ...
    date: new Date('2018'),
    description: [
      'Logogestaltung und CI für die Neurologische Praxis von Kristin Nowak in München.'
    ],
    position: 'Logoentwicklung',
  ...
  'gj-gin': {
    ...
    date: new Date('2019'),
    description: [
      'Etikettgestaltung für einen hauseigenen Gin anlässlich einer Firmenfeier von Gruner + Jahr Hamburg.'
    ],
  ...
  'landlust-zuhaus-logo': {
    ...
    date: new Date('2021'),
    description: [
      "Entwicklung eines neuen zeitgemäßen Logos für die Zeitschrift 'Landlust Zuhaus'."
    ],
    position: 'Logoentwicklung',
    company: 'Deutsche Medien-Manufaktur'
  },
